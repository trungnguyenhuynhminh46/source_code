 ...
 */
final class Version20231022111119 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoices (id INT AUTO_INCREMENT NOT NULL, amount BIGINT NOT NULL, invoice_number VARCHAR(255) NOT NULL, status INT NOT NULL, created_at DATETIME NOT NULL, due_date DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
